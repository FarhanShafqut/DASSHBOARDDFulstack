...
const StudentForm = () => {
  ...
  return (
    <div>
    <Sidebar/>
    <div className="max-w-xl mx-auto p-4 rounded-lg shadow-lg bg-white dark:bg-gray-800">
        <h1 className='my-10'>Enter Student Data Here</h1>
        <div className="mb-4">
          ...
          <input
            ...
            placeholder="John Alexa"
            required
            onChange={(e) => setUserName(e.target.value)}
          />
        </div>
        <div className="mb-4">
          <label htmlFor="adress" className="block text-sm font-medium text-gray-900 dark:text-white">
            Enter Address
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <div className="flex items-start">
            <input
              ...
              type="checkbox"
              value=""
              className="w-4 h-4 border rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800"
              required
            />
